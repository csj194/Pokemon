...
class GasAbsorption:
    ...
    hc2=3400.0#Pa/(kmol/m^3)
    antA= 6.20963
    antB=2354.731
    antC= 7.559
    gc10=5.000000 #kmol/s
    gc20=5.000000 #kmol/s
    gcl0=1.000000 #kmol/s
    lc10=1.000000 #kmol/s
...
#Operating Conditions:--------------------------------------------------------------------------------------------------        
        ...
        kl2a=kl2*a
        kga=kg*a
        Psat=(10**(antA-(antB/(Top+273.16+antC)))*(10**5))
        ...
        def set_diff_equat(molar_flow_rates,x,param):
            ...
            dgcldh=(kga*Ar*((yl*Pop)-Psat))/(R*(Top+273.16))
            
            dlc1dh=-kl1a*Ar*(((Pop*y1)/hc1)-(rhomolar*x1))
            dlc2dh=-kl2a*Ar*(((Pop*y2)/hc2)-(rhomolar*x2))
            dlcldh=(kga*Ar*((yl*Pop)-Psat))/(R*(Top+273.16))
